...
const securitySections = [
  {
    ...
    points: [
      'Creator Console is hosted on industry-leading cloud infrastructure: Google Cloud Platform(GCP) known for its robust security and scalability.',
  ...
  },
  {
    ...
    points: [
      'Creator Console is built for high availability with auto-scaling and failover support.',
  ...
  },
  {
    ...
    points: [
      ...
      'Report potential issues at security@creatorconsole.co.',
