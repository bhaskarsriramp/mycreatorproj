...
const TrustCenter = () => {
  ...
  const sections = [
    ...
    },
    {
      title: 'Privacy',
      bulletPoints: [
        'We collect only the data necessary to operate and improve Creator Console.',
    ...
    <>
      ...
      <Box sx={{ padding: isMobile ? 2 : 4, mt: 10, px: isMobile ? 2 : 10 }}>
        ...
        <Typography sx={{ fontSize: isMobile ? '18px' : '30px', fontWeight: 400 }} gutterBottom>
          Building trust with our users starts with transparency. The Creator Console Trust Center offers clear, in-depth insights into our approach to security, privacy, accessibility, and compliance.
        </Typography>
