...
const creatorUserSlice = createSlice({
  ...
  initialState: {
    ...
    creator_id: storedState?.creator_id || '',
    creator_category: storedState?.creator_category || '',
  },
...
const { login, logout } = creatorUserSlice.actions;

module.exports = {
  login,
  logout,
  reducer: creatorUserSlice.reducer
};
